...
const baseStyles: Record<ButtonVariant, string> = {
  ...
  action: 'px-4 py-2 text-sm font-medium rounded-md transition-colors flex items-center space-x-1 border border-gray-300 dark:border-gray-600 text-gray-200 dark:text-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800',
  refresh: 'px-4 py-2 text-sm font-medium rounded-md transition-colors flex items-center space-x-1 border border-gray-300 dark:border-gray-600 text-gray-200 dark:text-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800',
